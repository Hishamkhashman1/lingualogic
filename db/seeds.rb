...
task_level2 = Task.create!(goal: "Learn to jump", difficulty: 2, reward_exp: 100, reward_item1: "apple", reward_item2: "funny hat", name: "level5")
task_level3 = Task.create!(goal: "IF command", difficulty: 3, reward_exp: 100, reward_item1: "apple", reward_item2: "funny hat", name: "level5")
task_level4 = Task.create!(goal: "AND command", difficulty: 4, reward_exp: 100, reward_item1: "apple", reward_item2: "funny hat", name: "level5")
